 ...
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * | Pg Up| Shift|   Z  |   X  |   C  |   V  |   B  |      |   N  |   M  |   ,  |   .  |   /  |Enter | End  |
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * | Pg Dn|Adjust| Ctrl | Alt  | GUI  |Lower |Space |      |Space |Raise | Left | Down |  Up  | Right|   \  |
 * `------------------------------------------------'      `------------------------------------------------'
 */
  [_COLEMAK] = LAYOUT_ortho_5x14(
    KC_INS,  KC_GRV , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   ,     KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_BSLS, KC_LBRC,
    KC_MINS, KC_TAB , KC_Q   , KC_W   , KC_F   , KC_P   , KC_G   ,     KC_J   , KC_L   , KC_U   , KC_Y   , KC_SCLN, KC_BSPC, KC_RBRC,
    KC_EQL,  CTL_ESC, KC_A   , KC_R   , KC_S   , KC_T   , KC_D   ,     KC_H   , KC_N   , KC_E   , KC_I   , KC_O   , KC_QUOT, KC_HOME,
 ...
 */
  [_QWERTY] = LAYOUT_ortho_5x14(
    KC_INS,  KC_GRV , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   ,     KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_BSLS, KC_LBRC,
    KC_MINS, KC_TAB , KC_Q   , KC_W   , KC_E   , KC_R   , KC_T   ,     KC_Y   , KC_U   , KC_I   , KC_O   , KC_P   , KC_BSPC, KC_RBRC,
    KC_EQL,  CTL_ESC, KC_A   , KC_S   , KC_D   , KC_F   , KC_G   ,     KC_H   , KC_J   , KC_K   , KC_L   , KC_SCLN, KC_QUOT, KC_HOME,
 ...
 */
  [_LOWER] = LAYOUT_ortho_5x14(
    ...
    KC_PLUS, _______, KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  ,     KC_F6  , KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, _______,
 ...
 */
  [_RAISE] = LAYOUT_ortho_5x14(
    ...
    KC_PLUS, _______, KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  ,     KC_F6  , KC_MINS, KC_EQL , KC_LBRC, KC_RBRC, KC_BSLS, _______,
