 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Arrow| AltGr| Alt  | GUI  |Lwrspc|    Space    |Raispc| Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
...
[_ARROW] = LAYOUT_preonic_grid( \
  _______, _______, _______, _______, _______, _______, KC_NLCK, KC_P7, KC_P8, KC_P9, KC_PMNS, KC_SLCK,  \
  ...
  _______, _______, _______, _______, _______, _______, _______, KC_P0, KC_P0, KC_PCMM, KC_PENT, _______, \
