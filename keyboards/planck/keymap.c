...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //     KC_1,    KC_1,    KC_1,    KC_1   ,
    //     XXXXXXX, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,
    //     KC_I,    KC_O,    KC_P,    KC_LBRC,
    //     XXXXXXX, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,
    //     KC_K,    KC_L,    KC_SCLN, KC_QUOT, EXT_PLV, XXXXXXX, XXXXXXX, KC_C,
    //     KC_V,    XXXXXXX, XXXXXXX, KC_N,    KC_M,    XXXXXXX, XXXXXXX,
    //     XXXXXXX
    // ),
    // }}}
    /* Adjust (Lower + Raise) {{{
    ...
    [_ADJUST] = LAYOUT_planck_grid(
      ...
      _______, AU_PREV,  AU_NEXT,  MU_ON,   MU_OFF,  MI_ON,   MI_OFF,  _______, _______, _______, KC_F20, _______,
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______)
    // }}}
};
// }}}
