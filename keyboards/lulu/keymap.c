...
[_LOWER] = LAYOUT(
  ...
  KC_DEL,  KC_TRNS, KC_LEFT,   KC_DOWN, KC_UP,  KC_RIGHT,                   KC_UNDS, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
...
[_RAISE] = LAYOUT(
  ...
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_MPLY, _______,   KC_F12,  KC_NUHS, KC_NUBS,  KC_PGUP, KC_PGDN, KC_BSLS,
                             _______, _______, _______,  _______, _______,  _______, KC_DEL, _______
), // }}}
/* ADJUST {{{
 * ,-----------------------------------------.                    ,-----------------------------------------.
