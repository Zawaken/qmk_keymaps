...
[_LOWER] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______, KC_MPLY,  _______, KC_F12, S(KC_NUHS), S(KC_NUBS), KC_HOME, KC_END, _______,
...
[_RAISE] = LAYOUT(
  RGB_MOD, RGB_RMOD,RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD,                     RGB_TOG, _______, _______, _______, _______, QK_BOOT,
